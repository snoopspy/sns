...
## 10진수(unsigned) / 16진수 / 2진수 / 10진수(signed)
...
```
https://gitlab.com/gilgil/byte-order-test.git repository를 clone받아 실습을 진행한다.
...
* <b>#include <netinet/in.h></b> 혹은 <b>#include <arpa/inet.h></b> 하면 아래와 같은 함수들을 사용할 수 있다. 아래 함수들은 자신의 CPU가 LE이던지 BE이던지 상관없이 작동할 수 있도록 컴파일러가 자신의 byte order를 알고 처리해 준다.  
