...
Host OS에 설치해도 되나 대부분의 교육생이 Windows, macOS를 사용하는 관계로 virtual(VMware Workstation or VirtualBox) 환경에서 Guest OS로 Linux를 설치해 주시기 바랍니다(Memory는 4GB 이상 확보할 것 / CPU는 Host OS 갯수만큼 할당). Memory가 제한된 경우에는 USB로 multi booting할 수 있도록 준비해 놓으시기 바랍니다.
